	...
	<div class="container">
		...
		<div class="card o-hidden border-0 shadow-lg my-5">
			<div class="card-body p-0">
				...
				<div class="row">
					<div class="col-lg-6 d-none d-lg-block"><img src="<?= base_url('assets/img/bg_login.jpg'); ?>" class="img-fluid"></div>
					<div class="col-lg-6">
						<div class="p-5">
							...
							<form class="user" method="POST" action="">
								...
								<div class="form-group row">
									...
									<div class="col-sm-6">
										<input type="password" class="form-control form-control-user" id="exampleRepeatPassword" placeholder="Ulang KataSandi" name="password2">
									</div>
								</div>
